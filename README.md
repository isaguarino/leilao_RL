...
Hiperparâmetros: Oponente de Nash				Hiperparâmetros: Multiagentes		
α		0.2		γ		1.0
γ		1.0		α	inicial	0.4
ε 	inicial	1.0			mínimo	0.01
	mínimo	0.02			decaimento	0.9999995
	decaimento	0.999999		τ	inicial	1.0
# de episódios		6,000,000			mínimo	0.01
				# de episódios		10,000,000
<img width="786" height="241" alt="image" src="https://github.com/user-attachments/assets/3cb4c2ba-a1ba-4fa1-8bff-41a7b98e6018" />
